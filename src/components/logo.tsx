...
export function Logo({ className, type = 'square' }: { type?: 'square' | 'horizontal'; className?: string }) {
    ...
    return (
        ...
        >
            <div className="rounded-xl p-[2px] bg-gradient-to-r from-klave-cyan via-klave-blue to-klave-blue shadow-centered shadow-gray/50">
                <div className="bg-gray-50 p-5 rounded-[calc(1rem-2px)]">
